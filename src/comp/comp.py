...
print("Starts with D:")  # NOTE:for item in list if filter
...
char = ("C", "D", "E", "F", "G")
# NOTE: come back to try range
c = [i.name for i in humans if i.name.startswith(char)]
print(c)
...
f = [f"{i.name},{i.age}" for i in humans if 27 <= i.age <= 32]
print(f)
